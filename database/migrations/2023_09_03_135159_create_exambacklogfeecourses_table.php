...
class CreateExambacklogfeecoursesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('exambacklogfeecourses', function (Blueprint $table) {
            $table->id();
            $table->integer('backlogfee')->default(0); 
    ...
    {
        Schema::dropIfExists('exambacklogfeecourses');
    }
}
