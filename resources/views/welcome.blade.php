  ...
  <section>
    ...
    <section>
      ...
      <footer class="bg-white" aria-labelledby="footer-heading">
        ...
        <div class="mx-auto max-w-7xl px-5 py-12 md:px-12 lg:px-20 lg:py-16">
          <div class="xl:grid xl:grid-cols-3 xl:gap-8">
            <div class="space-y-8 xl:col-span-1">
              <a class="tracking-relaxed transform text-lg font-bold tracking-tighter text-blue-600 transition duration-500 ease-in-out lg:pr-8" href="/groups/footer/"> wickedblocks </a>
              <p class="mt-2 w-1/2 text-sm text-gray-500">Wicked templates for wicked dev's</p>
            </div>
            <div class="mt-12 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
              <div class="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h3 class="text-xs font-semibold uppercase tracking-wider text-blue-600">Solutions</h3>
                ...
                <div class="mt-12 md:mt-0">
                  <h3 class="text-xs font-semibold uppercase tracking-wider text-blue-600">Support</h3>
                  <ul role="list" class="mt-4 space-y-4">
                    <li>
              ...
              <div class="hidden md:grid md:grid-cols-1 lg:justify-end">
                <div class="mt-12 w-full md:mt-0">
                  <div class="mt-8 lg:justify-end xl:mt-0">
                    <h3 class="text-xs font-semibold uppercase tracking-wider text-blue-600">Subscribe to our newsletter</h3>
                    ...
                    <div class="inline-flex list-none items-center gap-2 lg:ml-auto">
                      <form action="" method="post" id="revue-form" name="revue-form" target="_blank" class="border2 mt-4 transform rounded-xl bg-gray-50 p-1 transition duration-500 ease-in-out sm:flex sm:max-w-lg">
                        ...
                        <div class="revue-form-actions mt-4 sm:ml-3 sm:mt-0">
                          <button type="submit" value="Subscribe" name="member[subscribe]" id="member_submit" class="block w-full rounded-lg border border-transparent bg-blue-600 px-5 py-3 text-base font-medium text-white shadow hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-300 sm:px-10">Notify me</button>
                        </div>
                      </form>
                    </div>
                  </div>
        ...
        <div class="mx-auto max-w-7xl bg-gray-50 px-5 py-12 sm:px-6 md:flex md:items-center md:justify-between lg:px-20">
          ...
          <div class="mt-8 md:order-1 md:mt-0">
            <span class="mt-2 text-sm font-light text-gray-500">
              Copyright © 2020 - 2021
              <a href="https://wickedlabs.dev" class="text-wickedblue mx-2 hover:text-gray-500" rel="noopener noreferrer">@wickedlabsHQ</a>. Since 2020
            </span>
          </div>
        </div>
      </footer>
