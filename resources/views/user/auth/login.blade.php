...
<div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 dark:bg-gray-900  px-2">
    ...
    <div class="w-full sm:max-w-md px-6 mt-2 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg">
        <div>
        ...
        <form method="POST" action="{{ route('user.login') }}">
            ...
            <div class="flex items-center justify-end mt-4">
                @if (Route::has('user.password.request'))
                    <a class="underline text-start text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800" href="{{ route('user.password.request') }}">
