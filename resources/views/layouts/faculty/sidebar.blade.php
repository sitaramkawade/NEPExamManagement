...
<x-sidebar.sidebar>
    ...
    @auth('faculty')
        ...
        <x-sidebar.sidebar-link route="faculty.view.faculty" name="Faculties">
        ...
        {{-- <x-sidebar.sidebar-link route="faculty.update-profile.faculty" name="Profile">
        ...
        <x-sidebar.sidebar-link route="faculty.view-role.faculty" name="Roles">
        ...
        <x-sidebar.sidebar-link route="faculty.view-roletype.faculty" name="Role Types">
