...
<x-sidebar.sidebar>
    ...
    @auth('faculty')
        ...
        <x-sidebar.sidebar-link route="faculty.all-subjectcategories" name="Subject Categorie's">
        ...
        <x-sidebar.sidebar-link route="faculty.all-subjecttypes" name="Subject Type's">
        ...
        <x-sidebar.sidebar-link route="faculty.all-subjectverticals" name="Subject Vertical's">
        ...
        <x-sidebar.sidebar-link route="faculty.all-subjects" name="Subject's">
        ...
        <x-sidebar.sidebar-link route="faculty.all-deptprefixes" name="Department Prefixes">
        ...
        <x-sidebar.sidebar-link route="faculty.all-internaltool" name="Internal Tool's">
        ...
        <x-sidebar.sidebar-link route="faculty.all-internaltooldocs" name="Tool Document's">
        ...
        <x-sidebar.sidebar-link route="faculty.all-assigntools" name="Assign Tool's">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.75 6.75h16.5M3.75 12H12m-8.25 5.25h16.5" />
        </x-sidebar.sidebar-link>
        <x-sidebar.sidebar-link route="faculty.all-uploadocs" name="Upload Document's">
        ...
        <x-sidebar.sidebar-link route="faculty.all-faculties" name="Facultie's">
        ...
        <x-sidebar.sidebar-link route="faculty.view-exampanels" name="Create Panel's">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
        </x-sidebar.sidebar-link>
        <x-sidebar.sidebar-link route="faculty.all-facultyheads" name="Faculty Head's">
        ...
        <x-sidebar.sidebar-link route="faculty.all-roles" name="Roles">
        ...
        <x-sidebar.sidebar-link route="faculty.all-roletypes" name="Role Type's">
