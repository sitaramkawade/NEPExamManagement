                    ...
                    <section x-show="open" x-collapse.duration.500ms>
                        ...
                        <div class=" flex-none md:flex   py-4">
                            ...
                            <div class="flex-1 px-2">
                                ...
                                <div>
                                    <x-input-label for="c_pincode" :value="__('City / Village/Locality')" />
                                    <x-text-input id="c_pincode" name="c_pincode" type="number"
                                        class="mt-2 block w-full" autocomplete="c_pincode" />
                                    <x-input-error :messages="$errors->updatePassword->get('c_pincode')" class="mt-2" />
                                </div>
                        ...
                        {{-- <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6    border-t-2 border-solid border-gray-200"  >
                            @csrf
                            @method('put')
                ...
                <div class=" max-w-full  " x-data={open:true}>
                    ...
                    <section x-show="open" x-collapse.duration.500ms>
                        ...
                        <form method="post" action="{{ route('password.update') }}"
                            class="mt-6 space-y-6    border-t-2 border-solid border-gray-200">
                            @csrf
                            @method('put')
