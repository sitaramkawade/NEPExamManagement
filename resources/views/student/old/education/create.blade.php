                                ...
                                <div class=" max-w-full  " x-data={open:true}>
                                    ...
                                    <section x-show="open" x-collapse.duration.500ms>
                                        ...
                                        <div class=" flex-none md:flex   py-4">
                                            <div class="  flex-1 space-y-6">
                                                ...
                                                <div class="max-w-2xl mx-auto">
                                                    ...
                                                    <select
                                                        ...
                                                        <option value="" selected readonly>
                                                            {{ $studentaddress->taluka->district->state->country->country_name }}
                                                        </option>
                                                ...
                                                <div class="max-w-2xl mx-auto">
                                                    ...
                                                    <select
                                                        ...
                                                        id="state" readonly>
                                                        <option value="">
                                                            {{ $studentaddress->taluka->district->state->state_name }}
                                                        </option>
                                                ...
                                                <div class="max-w-2xl mx-auto">
                                                    ...
                                                    <select
                                                        ...
                                                        <option value="">
                                                            {{ $studentaddress->taluka->district->district_name }}
                                                        </option>
                                                ...
                                                <div class="max-w-2xl mx-auto">
                                                    ...
                                                    <select
                                                        ...
                                                        <option value="">
                                                            {{ $studentaddress->taluka->taluka_name }}</option>
                                            ...
                                            <div class="flex-1 px-2 space-y-6">
                                                ...
                                                <div>
                                                    ...
                                                    <x-text-input id="c_village_name" :value="$studentaddress->village_name" readonly
                                                ...
                                                <div>
                                                    ...
                                                    <x-text-input id="pincode" :value="$studentaddress->pincode" readonly
                                                        type="number" class="mt-2 block w-full"
                                        ...
                                        <div class=" bg-slate-100 flex  justify-center px-7">
                                            ...
                                            <form method="POST"
                                                action="{{ route('student.AddressDetails.destroy', $studentaddress->id) }}">
                                                @csrf
                                                @method('DELETE')
