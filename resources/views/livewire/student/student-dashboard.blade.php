              ...
              <x-table.tr>
                ...
                <x-table.td>
                  @if ($exm_form->feepaidstatus == 0)
                    <x-dashboard.form-button class="bg-green-500 h-7 rounded-md border-0" action="{{ route('student.student_pay_exam_form_fee', $exm_form->id) }}"> Pay Fee</x-dashboard.form-button>
                  @endif
                  @if ($exm_form->printstatus==0 && $exm_form->inwardstatus==0)
                    <x-dashboard.form-button class="bg-red-500 h-7 rounded-md border-0" action="{{ route('student.student_delete_exam_form') }}"> Delete Exam Form </x-dashboard.form-button>
                    <x-dashboard.form-button class="bg-pink-500 h-7 rounded-md border-0" target="_blank" action="{{ route('student.student_print_preview_exam_form') }}"> Preview Exam Form </x-dashboard.form-button>
                  @endif
