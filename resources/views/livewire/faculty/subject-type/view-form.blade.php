<x-card-collapsible heading="Subject Bucket Details">
    ...
    <div class="grid grid-cols-1 md:grid-cols-1">
        <div class="px-5 py-2 text-sm text-gray-600 dark:text-gray-400">
            ...
            @if ($isDisabled)
                <x-text-input id="active" type="text" :value="$active == 1 ? 'Active' : 'Inactive'" disabled class="bg-gray-100 cursor-not-allowed @error('active') is-invalid @enderror w-full mt-1" />
            @endif
        </div>
    </div>
</x-card-collapsible>
