<div class="m-2 overflow-hidden rounded border bg-white shadow dark:border-primary-darker dark:bg-darker">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2">
        ...
        <div class="px-5 py-2 text-sm text-gray-600 dark:text-gray-400">
            ...
            <x-input-show id="tool_name" :value="$tool_name" />
        </div>
        <div class="px-5 py-2 text-sm text-gray-600 dark:text-gray-400">
        ...
        <div class="px-5 py-2 text-sm text-gray-600 dark:text-gray-400">
            <x-input-label for="verifybyfaculty_id" :value="__('Verified By Faculty Name')" />
            <x-input-show id="verifybyfaculty_id" :value="$verifybyfaculty_id" />
        </div>
    </div>
    <div class="grid grid-cols-1 md:grid-cols-1">
        <div class="px-5 py-2 text-sm text-gray-600 dark:text-gray-400">
            <x-input-label for="verificationremark" :value="__('Verification Remark')" />
            <x-input-show id="verificationremark" :value="$verificationremark" />
        </div>
    </div>
</div>
<div class="m-2 overflow-hidden rounded border bg-white shadow dark:border-primary-darker dark:bg-darker">
