        ...
        <div class="m-2 overflow-hidden rounded border bg-white shadow dark:border-primary-darker dark:bg-darker">
            ...
            <div class="grid grid-cols-1 md:grid-cols-1">
                ...
                <div class="px-5 py-2 text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <x-select2.select style="width:100%;" id="patternclass_id" name="patternclass_id" wire:model='patternclass_id'  >
                        <x-select2.option hidden> -- Select Pattern Class -- </x-select2.option>
                        @forelse ($pattern_classes as $pattern_class)
                            <x-select2.option wire:key="{{ $pattern_class->id }}" value="{{ $pattern_class->id }}" class="text-start">{{ get_pattern_class_name($pattern_class->id) }}</x-select2.option>
                        @empty
