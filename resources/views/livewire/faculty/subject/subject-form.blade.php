    ...
    <x-slot name="content">
        <div class="grid grid-cols-1 md:grid-cols-3">
            <div class="px-5 py-2 text-sm text-gray-600 dark:text-gray-400">
                <x-input-label for="subject_sem" :value="__('Subject Sem')" />
                <x-input-select id="subject_sem" wire:model="subject_sem" name="subject_sem" class="text-center @error('subject_sem') is-invalid @enderror w-full mt-1" :value="old('subject_sem', $subject_sem)" required autofocus autocomplete="subject_sem">
                    ...
                    <x-select-option class="text-start" value="5">5</x-select-option>
                    <x-select-option class="text-start" value="6">6</x-select-option>
                    <x-select-option class="text-start" value="7">7</x-select-option>
                    <x-select-option class="text-start" value="8">8</x-select-option>
                </x-input-select>
            ...
            <div class="px-5 py-2 text-sm text-gray-600 dark:text-gray-400">
                ...
                <x-text-input id="subject_no" type="text" wire:model="subject_no" name="subject_no" placeholder="Subject Number" class=" @error('subject_no') is-invalid @enderror w-full mt-1" :value="old('subject_no', $subject_no)" required autofocus autocomplete="subject_no" />
