                    ...
                    <div class="m-2 pb-3 overflow-hidden bg-white border rounded  shadow dark:border-primary-darker dark:bg-darker ">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3">
                            <div class="px-5 py-2 text-sm text-gray-600 dark:text-gray-400">
                                ...
                                <x-text-input id="permanant_address" type="text" class="@error('permanant_address') is-invalid @enderror w-full mt-1" :value="old('permanant_address', $permanant_address)" required autofocus autocomplete="permanant_address" />
