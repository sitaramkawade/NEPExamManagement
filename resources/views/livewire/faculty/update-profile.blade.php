<div>
    <section>
        <form wire:submit="updateProfile()" method="post" action="" id="myForm">
                ...
                <x-slot name="content">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3">
                        ...
                        <div class="px-5 py-2 text-sm text-gray-600 dark:text-gray-400">
                            ...
                            <x-text-input id="current_address" type="text" wire:model="current_address" class="@error('current_address') is-invalid @enderror w-full mt-1" :value="old('current_address', $current_address)" required autofocus autocomplete="current_address" />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3">
                        <div class="px-5 py-2 text-sm text-gray-600 dark:text-gray-400">
                            ...
                            <x-text-input id="permanant_address" wire:model="permanant_address" type="text" class="@error('permanant_address') is-invalid @enderror w-full mt-1" :value="old('permanant_address', $permanant_address)" required autofocus autocomplete="permanant_address" />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3">
                        <div class="m-5 col-span-1 rounded-md bg-white dark:bg-darker dark:border-primary-darker border">
                            <div class="flex items-center justify-between border-b p-4 dark:border-primary">
                                <h4 class="text-lg font-semibold text-gray-500 dark:text-light">Upload Profile Photo</h4>
                            </div>
            ...
            <x-container heading="Bank Details">
