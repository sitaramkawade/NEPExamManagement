            ...
            <div class="m-2 overflow-hidden bg-white border rounded  shadow dark:border-primary-darker dark:bg-darker ">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="px-5 py-2 text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <x-required />
                        <x-text-input id="max_percentage" type="text" wire:model="max_percentage" name="max_percentage" class="w-full mt-1" :value="old('max_percentage',$max_percentage)" required autofocus autocomplete="max_percentage" />
                    ...
                    <div class="px-5 py-2 text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <x-required />
                        <x-text-input id="min_percentage" type="text" wire:model="min_percentage" name="min_percentage" class="w-full mt-1" :value="old('min_percentage',$min_percentage)" required autofocus autocomplete="min_percentage" />
                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div class="px-5 py-2 text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <x-required />
                        <x-text-input id="grade_point" type="text" wire:model="grade_point" name="grade_point" class="w-full mt-1" :value="old('grade_point',$grade_point)" required autofocus autocomplete="grade_point" />
