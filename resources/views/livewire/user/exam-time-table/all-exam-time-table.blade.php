                    ...
                    <x-table.table>
                        ...
                        <x-table.tbody>
                            ...
                            <x-table.tr wire:key="{{ $ExamTimeTable->id }}">
                                ...
                                <x-table.td>
                                    <x-table.text-scroll> {{ $ExamTimeTable->subject?->subject_name }} </x-table.text-scroll>
                                </x-table.td>
                                <x-table.td> {{ $ExamTimeTable->exampatternclass->courseclass->course->course_name }} </x-table.td>
