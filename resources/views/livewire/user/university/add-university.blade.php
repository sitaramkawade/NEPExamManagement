        ...
        <section>
            <form wire:submit="add">
                <div class="m-2 overflow-hidden bg-white border rounded  shadow dark:border-primary-darker dark:bg-darker ">
                   <x-card-header href="{{ route('user.viewUniversity') }}">
                        Add University
                        <x-slot name="svg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="px-5 py-2 text-sm text-gray-600 dark:text-gray-400">
                            <x-input-label for="university_name" :value="__('University Name')" /><x-required/>
                        ...
                        <div class="px-5 py-2 text-sm text-gray-600 dark:text-gray-400">
                            <x-input-label for="university_email" :value="__('University email')" /><x-required/>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div>
                         ...
                         <div class="px-5 py-2 text-sm text-gray-600 dark:text-gray-400">
                            <x-input-label for="university_contact_no" :value="__('University Contact No')" /><x-required/>
                            ...
                            <x-input-error :messages="$errors->get('university_contact_no')" class="mt-2" />
                             ...
                             <div class="px-5 py-2 text-sm text-gray-600 dark:text-gray-400">
                                <x-input-label for="university_address" :value="__('University Address')" /><x-required/>
                        ...
                        <div class="px-5 py-2 text-sm text-gray-600 dark:text-gray-400">
                            <x-input-label for="university_website_url" :value="__('University Website URL ')" /><x-required/>
