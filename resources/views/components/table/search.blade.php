<div class="inline-flex items-center min-w-[20%] mx-auto">
  ...
  <div class="relative w-full">
    ...
    <input type="search" wire:model.live.debounce.3s="search" id="simple-search" {!! $attributes->merge(['class' => 'bg-gray-50 border border-gray-300 dark:placeholder:text-white placeholder:text-gray-800 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 dark:bg-slate-900 dark:border-primary-darker dark:text-white dark:focus:ring-primary dark:focus:border-parimary']) !!} placeholder="Search" required />
  </div>
</div>
