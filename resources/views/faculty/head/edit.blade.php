<x-faculty-layout>
    ...
    <div class="py-12 ">
        ...
        <div class="mt-4">
            ...
            value="{{ old('email', $faculty->email) }}" required autocomplete="username" />
            <x-input-error :messages="$errors->get('email')" class="mt-2" />
        </div>
                                    <div>
                                        <x-input-label for="mobile" value="{{ __('Mobile Number') }}" />
                                        <x-text-input id="mobile" class="block mt-1 w-full" type="text" name="mobile" 
                                        value="{{ old('mobile', $faculty->mobile_no) }}" required autofocus autocomplete="name" />
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <option value="" disabled >
                                            ...
                                            @if(isset($faculty)) 
                                            @if($item->id==$faculty->college_id) selected 
                                            @endif @endif >
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <select id="dept"  class="block mt-1 w-full rounded" name="dept">
                                            ...
                                            <option value={{$item->id}} 
                                            @if(isset($faculty)) 
                                            @if($item->id==$faculty->department_id) selected 
                                            @endif @endif >
                                      ...
                                      <div class="mt-4">
                                        ...
                                        <select id="role"  class="block mt-1 w-full rounded" name="role">
                                            ...
                                            <option value={{$item->id}}  
                                            @if(isset($faculty)) 
                                            @if($item->id==$faculty->role_id) selected 
                                            @endif @endif >
                                      ...
                                      <div>
                                        ...
                                        <x-text-input id="account_no" class="block mt-1 w-full" type="text" name="account_no" 
                                        value="{{ old('account_no', $faculty->facultybankaccount->account_no) }}" required autofocus autocomplete="name" />
                                        <x-input-error :messages="$errors->get('account_no')" class="mt-2" />
                                    </div>
                                    <div>
                                        <x-input-label for="bank_address" value="{{ __('Bank Address') }}" />
                                        <x-text-input id="bank_address" class="block mt-1 w-full" type="text" name="bank_address" 
                                        value="{{ old('bank_address', $faculty->facultybankaccount->bank_address) }}" required autofocus autocomplete="name" />
                                    ...
                                    <div>
                                        ...
                                        value="{{ old('bank_name', $faculty->facultybankaccount->bank_name) }}" required autofocus autocomplete="name" />
                                    ...
                                    <div>
                                        ...
                                        value="{{ old('branch_name', $faculty->facultybankaccount->branch_name) }}" required autofocus autocomplete="name" />
                                        <x-input-error :messages="$errors->get('branch_name')" class="mt-2" />
                                    </div>
                                    <div>
                                        <x-input-label for="branch_code" value="{{ __('Branch Code') }}" />
                                        <x-text-input id="branch_code" class="block mt-1 w-full" type="text" name="branch_code" 
                                        value="{{ old('branch_code', $faculty->facultybankaccount->branch_code) }}" required autofocus autocomplete="name" />
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="ifsc_code" class="block mt-1 w-full" type="text" name="ifsc_code" 
                                        value="{{ old('ifsc_code', $faculty->facultybankaccount->ifsc_code) }}" required autofocus autocomplete="name" />
                                        <x-input-error :messages="$errors->get('ifsc_code')" class="mt-2" />
                                    </div>
                                    <div>
                                        <x-input-label for="micr_code" value="{{ __('MICR CODE') }}" />
                                        <x-text-input id="micr_code" class="block mt-1 w-full" type="text" name="micr_code" 
                                        value="{{ old('micr_code', $faculty->facultybankaccount->micr_code) }}" required autofocus autocomplete="name" />
